...
<table width="1007" height="376" border="0" align="center" colspan="4">
  ...
  <tr>
    <td height="28" colspan="3" class="TABLA" align="justify">Bolivariana de Puertos, S.A. le notifica que su Modificacion de la Clave de Aceso  ha sido realizado de manera exitosa, por lo tanto le mostramos los datos de Acceso al Sistema:</td>
  </tr> 
   <tr>
  ...
  <tr>
    <td><div align="right">Correo Alternativo Modificado</div></td>
    <td>'.$correo_2.'&nbsp;</td>
  </tr>
  <tr>
	...
	$to = $correo_2;
	//$correo_1; //Para quien se le va enviar
