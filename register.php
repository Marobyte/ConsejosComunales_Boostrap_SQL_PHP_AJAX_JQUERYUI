  ...
  <div class="register-box-body">
    ...
    <form>
      ...
      <select class="form-control" id="sig_rif">
       ...
       <button type="button" class="btn btn-primary btn-block btn-flat"class="btn btn-primary btn-block btn-flat" onclick="buscar_rif()" id="busca_rif">Buscar</button><button type="button" class="btn btn-danger btn-block btn-flat" onclick="cancelar_busqueda()" id="equis">Otra Busqueda</button>
       <br>
