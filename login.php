...
<div class="login-box">
  <div class="login-logo">
    <a href="inicio_sesion.php"><b>Consejos </b>Comunales</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Registro de Informacion Fiscal (RIF)" id="usuario">
    ...
    <a href="#">¿No Puedes Ingresar al Sistema?</a><br>
    <a href="register.html" class="text-center">¿Aun no te has Registrado?</a>
